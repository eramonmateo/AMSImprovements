...
$timein_sql = "SELECT u.name, eu.department, u.position, t.datetime AS timein, o.datetime AS timeout, n.type, n.date
                FROM users u
...
$timein_sql = "SELECT u.name, ii.department, u.position, t.datetime AS timein, o.datetime AS timeout, n.type, n.date
                FROM users u
