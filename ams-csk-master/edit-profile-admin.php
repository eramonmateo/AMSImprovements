...
$editName = isset($_GET['editProfileUsername']) ? $_GET['editProfileUsername'] : '';
...
<body>
    <section id="section">
        ...
        <main>
            ...
            <form action="edit-profile-save.php?editProfileUsername=<?php echo $editName; ?>"       method="POST" id="edit-acc-form" enctype="multipart/form-data">
